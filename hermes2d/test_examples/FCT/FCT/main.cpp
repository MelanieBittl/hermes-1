...
int time_counter =1.;
	...
	Solution<double>::vector_to_solution(coeff_vec, space, low_sln);
			...
			Solution<double>::vector_to_solution(coeff_vec_2, space, high_sln);
...
/*
	Linearizer lin;
lin.save_solution_vtk(u_new, "fct3d.vtk", "solution", true);
lin.save_solution_vtk(u_new, "fct2d.vtk", "solution", false);
lin.save_solution_vtk(low_sln, "low3d.vtk", "solution", true);
lin.save_solution_vtk(low_sln, "low2d.vtk", "solution", false);
lin.save_solution_vtk(high_sln, "hi3d.vtk", "solution", true);
lin.save_solution_vtk(high_sln, "hi2d.vtk", "solution", false);

//lin.save_solution_vtk(u_prev_time, "init3d.vtk", "solution", true);
