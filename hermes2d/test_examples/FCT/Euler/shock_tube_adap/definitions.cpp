#include "definitions.h"
  ...
  EulerEquationsWeakForm_Mass::EulerEquationsWeakForm_Mass(double time_step, int num_of_equations): WeakForm<double>(num_of_equations)
	{
	    ...
	    WeakForm<double>* EulerEquationsWeakForm_Mass::clone() const
    {
      ...
      return new EulerEquationsWeakForm_Mass(*this);
    }
