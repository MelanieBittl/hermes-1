...
{
public:
  CustomInitialCondition_rho_v_y(MeshSharedPtr mesh, double gamma) : ExactSolutionScalar<double>(mesh), gamma(gamma) {};
...
{
public:
  BoundaryCondition_rho(MeshSharedPtr mesh,double gamma) : ExactSolutionScalar<double>(mesh), gamma(gamma){};
...
{
public:
  BoundaryCondition_rho_e(MeshSharedPtr mesh,double gamma) : ExactSolutionScalar<double>(mesh), gamma(gamma) {};
...
{
public:
  BoundaryCondition_rho_v_x(MeshSharedPtr mesh,double gamma) : ExactSolutionScalar<double>(mesh), gamma(gamma){};
...
{
public:
  BoundaryCondition_rho_v_y(MeshSharedPtr mesh,double gamma) : ExactSolutionScalar<double>(mesh), gamma(gamma) {};
