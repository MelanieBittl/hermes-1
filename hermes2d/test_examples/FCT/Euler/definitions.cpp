    ...
    Solution<double>* prev_density_vel_y, Solution<double>* prev_energy, int num_of_equations): WeakForm<double>(num_of_equations)
{
    ...
    MatrixFormVol<double>* EulerEquationsBilinearFormTime::clone() { return new EulerEquationsBilinearFormTime(component_i); }
    ...
    VectorFormVol<double>* EulerEquationsLinearFormTime::clone() { return new EulerEquationsLinearFormTime(component_i); }
