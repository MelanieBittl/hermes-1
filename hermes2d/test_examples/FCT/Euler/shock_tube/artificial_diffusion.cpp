...
UMFPackMatrix<double>* artificialDiffusion(double kappa,double* coeff,SpaceSharedPtr<double> space_rho,SpaceSharedPtr<double> space_rho_v_x, SpaceSharedPtr<double> space_rho_v_y,SpaceSharedPtr<double> space_e,int dof_rho, int dof_vel_x, int dof_vel_y, int dof_energy,UMFPackMatrix<double>* matrix_K){
