...
//--------------Weakforms------------
  ...
  EulerBoundary* wf_boundary_init = new EulerBoundary(KAPPA, Hermes::vector<MeshFunctionSharedPtr<double> >(init_rho, init_rho_v_x, init_rho_v_y, init_e,init_rho, init_rho_v_x, init_rho_v_y,  init_e) );
