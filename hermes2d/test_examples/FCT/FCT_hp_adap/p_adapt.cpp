...
bool h_p_adap(SpaceSharedPtr<Scalar> space,MeshFunctionSharedPtr<Scalar> u_prev_time, MeshFunctionSharedPtr<Scalar> sln,MeshFunctionSharedPtr<Scalar> R_h_1,MeshFunctionSharedPtr<Scalar> R_h_2, CustomWeakFormMassmatrix* massmatrix, HPAdapt* adapt, AsmList<Scalar>* al,  double h_min, double h_max, int ts, int ps, int* smooth_elem, double h_start)
{		
