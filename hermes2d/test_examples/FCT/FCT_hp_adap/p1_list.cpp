...
template<typename Scalar>
void p1_list(SpaceSharedPtr<Scalar> space, AsmList<Scalar>* dof_list,AsmList<Scalar>* dof_list_2, AsmList<Scalar>* al, std::list<int>* list, std::list<int>* list_2,double* x, double* y )
{
	int test =0;
	Element* e =NULL;
	Element* parent =NULL;
...
/*
template<typename Scalar>
void p1_list_fast_neighbor(SpaceSharedPtr<Scalar> space, AsmList<Scalar>* dof_list,AsmList<Scalar>* dof_list_2, AsmList<Scalar>* al,std::list<int>* list){
