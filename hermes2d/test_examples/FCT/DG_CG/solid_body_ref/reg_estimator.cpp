...
Regularity_Estimator_slope::Regularity_Estimator_slope(Space<double>* space): Regularity_Estimator(0.), space(space)
{ 	lin_sln 	  =  new RegSolution(space);
	lin_sln_dx =  new RegSolution(space);
	lin_sln_dy =  new RegSolution(space);

};

Regularity_Estimator_slope::~Regularity_Estimator_slope()
{
	delete lin_sln; 
	delete lin_sln_dx; 
	delete lin_sln_dy;
...
void Regularity_Estimator_slope::smoothness_indicator(UMFPackMatrix<double> * mass_matrix)
	{
...
//R_H^1 
   ...
   MatrixFormVol<double>* GradientReconstructionMatForm_1::clone() const
		{
			return new GradientReconstructionMatForm_1(this->i, this->j);
		}
  ...
  double GradientReconstructionVectorForm_1::value(int n, double *wt, Func<double> *u_ext[], Func<double> *v, Geom<double> *e, Func<double>  **ext) const {
   ...
   {
 			 return new GradientReconstructionVectorForm_1(this->i);
		}
...
/*	GradientReconstruction_2::~GradientReconstruction_2()
                       ...
                       Func<Real> *v, Geom<Real> *e, Func<Scalar>  **ext) const 
    {
		...
		{
		return new GradientReconstructionMatForm_2(this->i, this->j);
		}
  ...
  double GradientReconstructionVectorForm_2::value(int n, double *wt, Func<double> *u_ext[], Func<double> *v, Geom<double> *e, Func<double>  **ext) const {
   ...
   {
 			 return new GradientReconstructionVectorForm_2(this->i);
		}
