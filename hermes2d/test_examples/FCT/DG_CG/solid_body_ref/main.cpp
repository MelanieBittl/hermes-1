...
{  
 ...
 // Initialize solution of lower & higher order
  ...
  L2ProjBasedSelector<double> selector(CAND_LIST, CONV_EXP, H2DRS_DEFAULT_ORDER);
	...
	UMFPackMatrix<double>* surface_matrix = new UMFPackMatrix<double> ; //inner and outer edge integrals
...
//Unrefinement step
     ...
     // Space<double>* ref_space = ref_space_creator.create_ref_space();
      L2_SEMI_CG_Space<double>* ref_space = ref_space_creator.create_ref_l2_semi_cg_space();
