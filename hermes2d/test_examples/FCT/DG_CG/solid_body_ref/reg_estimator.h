...
protected:
	...
	virtual void smoothness_indicator(UMFPackMatrix<double> * mass_matrix=NULL);
...
class Regularity_Estimator_slope : public Regularity_Estimator
{
public:
	Regularity_Estimator_slope(Space<double>* space);
	~Regularity_Estimator_slope();

protected:
virtual void smoothness_indicator(UMFPackMatrix<double> * mass_matrix=NULL);

	RegSolution* lin_sln;
	RegSolution* lin_sln_dx;
	RegSolution* lin_sln_dy;
	Space<double>* space;
