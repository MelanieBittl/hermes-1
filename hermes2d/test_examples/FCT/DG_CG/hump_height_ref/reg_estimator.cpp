...
/*Hermes::Hermes2D::Views::ScalarView s1view("Solution", new WinGeom(0, 500, 500, 400));
Hermes::Hermes2D::Views::ScalarView s2view("Solution", new WinGeom(0, 500, 500, 400));
s1view.show(R_h_1);
s2view.show(R_h_2);
View::wait();*/
...
//if(std::min(smooth_dx_in_elem,smooth_dy_in_elem)==1)
//if(smooth_fct_in_elem==1)
