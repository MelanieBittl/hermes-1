...
Space<double>::assign_dofs(spaces);
  ...
  MeshFunctionSharedPtr<double> boundary_rho(new CustomBoundaryCondition_rho(mesh,current_time));	
  MeshFunctionSharedPtr<double> boundary_v_x(new   CustomBoundaryCondition_v_x(mesh,current_time));	
  MeshFunctionSharedPtr<double> boundary_v_y(new   CustomBoundaryCondition_v_y(mesh,current_time));	
  MeshFunctionSharedPtr<double> boundary_e(new CustomBoundaryCondition_e(mesh,KAPPA,current_time));	
