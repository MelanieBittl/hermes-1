...
//NumericalFlux* num_flux =new VijayasundaramNumericalFlux(KAPPA);
  ...
  EulerEquationsWeakForm_Mass wf_mass;
	...
	EulerS wf_bdry_init(KAPPA,mesh,num_flux, boundary_rho, boundary_v_x, boundary_v_y,  boundary_e, init_rho, init_rho_v_x, init_rho_v_y, init_e,mirror_bdry);
	EulerS wf_bdry(KAPPA,mesh, num_flux,boundary_rho, boundary_v_x, boundary_v_y,  boundary_e, prev_rho, prev_rho_v_x, prev_rho_v_y, prev_e,mirror_bdry);
...
while ((ts <2000)&&(residual_norm>1e-8));
