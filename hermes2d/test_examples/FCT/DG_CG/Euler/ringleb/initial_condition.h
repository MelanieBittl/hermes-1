...
{
public:
  BoundaryCondition_rho(MeshSharedPtr mesh,double kappa) : ExactSolutionScalar<double>(mesh), kappa(kappa), time(time)  {};
...
{
public:
  BoundaryCondition_rho_e(MeshSharedPtr mesh,double kappa) : ExactSolutionScalar<double>(mesh), kappa(kappa), time(time)  {};
