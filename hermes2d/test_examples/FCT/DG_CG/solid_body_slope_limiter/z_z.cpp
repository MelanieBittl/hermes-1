...
void calc_z_z_error( SpaceSharedPtr<double> ref_space, MeshFunctionSharedPtr<double> u_fct, MeshFunctionSharedPtr<double> R_h_1_fct, MeshFunctionSharedPtr<double> R_h_2_fct, double* elem_error)
{
      // order of integral
      const int order = 20;
...
Solution<double>* R_h_2 = new Solution<double>; R_h_2= static_cast<Solution<double>* > (R_h_2_fct->clone());
      ...
      for_all_active_elements( e, ref_space->get_mesh() ) {
		...
		delete rm;
delete u; delete R_h_1; delete R_h_2;
