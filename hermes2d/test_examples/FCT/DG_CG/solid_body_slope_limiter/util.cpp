...
Solution<double>* sln_1 = new Solution<double>;
 sln_1 = static_cast<Solution<double>* > (sln_1_fct->clone());
Solution<double>* sln_2 =NULL;
if(sln_2_fct!=NULL)
{
sln_2 = new Solution<double>;
 sln_2 = static_cast<Solution<double>* > (sln_2_fct->clone());
}
...
delete refmap; delete sln_1; if(sln_2 !=NULL) delete sln_2;
