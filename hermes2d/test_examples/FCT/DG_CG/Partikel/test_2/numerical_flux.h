...
{
public:
  StegerWarmingNumericalFlux(double gamma);
...
{
public:
  VijayasundaramNumericalFlux(double gamma);
...
{
public:
  OsherSolomonNumericalFlux(double gamma);
...
{
public:
  LaxFriedrichsNumericalFlux(double gamma);
...
{
public:
  ApproxRoeNumericalFlux(double gamma,EulerFluxes* euler_flux);
