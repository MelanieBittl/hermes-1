...
SimpleVector<double>*  vec_bdry,double* u_L, double* flux_scalar, double* P_plus, double* P_minus, double* Q_plus, double* Q_minus, double* R_plus, double* R_minus, int dof_rho, double time_step, double gamma )
{ 
