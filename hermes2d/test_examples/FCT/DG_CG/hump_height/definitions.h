...
{
public:
  CustomWeakForm(MeshFunctionSharedPtr<double> sln_exact,MeshFunctionSharedPtr<double> sln_prev_time,MeshSharedPtr mesh,double time_step,double theta,double theta_DG, bool all = false, bool DG = true, bool right_hand_side = true);
