...
{
public:
  AuxiliarySolution(const Mesh* mesh, bool x_component, double c) : ExactSolutionScalar<double>(mesh), x_component(x_component), c(c) {};
...
//Shapeset of local Taylor basis functions
 ...
 public:
    ...
    TaylorShapeset();
    TaylorShapeset(Element* e,Space<double>* space);
    ~TaylorShapeset();
   void init_data(Element* e,Space<double>* new_space);
