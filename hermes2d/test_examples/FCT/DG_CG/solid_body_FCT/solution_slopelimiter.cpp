...
void SlopeLimiterSolution::set_diff_linear()
  ...
  RegSolution::RegSolution(Space<double>* space):Solution<double>(space->get_mesh()), space(space)  {  };

void RegSolution::linear_approx(double* u_c, Solution<double>* R_h_1, Solution<double>* R_h_2)
    {
     int o;			
		this->increasePointerDataCounter();
      free();
...
void RegSolution::linear_approx_d(double* u_c_d, Solution<double>* R_h)
    {
     int o;			
		this->increasePointerDataCounter();
      free();
