...
delete refmap;
 ...
 double VolumeAverage::calculate_norm(Element* e,Space<double>* space, Solution<double>* sln)
 {
 
 	if(e==NULL) Hermes::Exceptions::Exception("Volume_Average:calculate_norm Element* e ==NULL");
	if(sln==NULL) Hermes::Exceptions::Exception("Volume_Average:calculate_norm sln_1 ==NULL");
