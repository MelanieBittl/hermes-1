...
//----------------Bilinearform for Surf
 ...
 class EulerEquationsBilinearFormBoundary_rho: public MatrixFormSurf<double>
  {
  public:
    EulerEquationsBilinearFormBoundary_rho(double kappa) : MatrixFormSurf<double>(0,0), kappa(kappa) {}
 ...
 class EulerEquationsBilinearFormBoundary_vel_x: public MatrixFormSurf<double>
  {
  public:
    EulerEquationsBilinearFormBoundary_vel_x(double kappa) : MatrixFormSurf<double>(1,1), kappa(kappa) {}
 ...
 class EulerEquationsBilinearFormBoundary_vel_y: public MatrixFormSurf<double>
  {
  public:
    EulerEquationsBilinearFormBoundary_vel_y(double kappa) : MatrixFormSurf<double>(2,2), kappa(kappa) {}
 ...
 class EulerEquationsBilinearFormBoundary_e: public MatrixFormSurf<double>
  {
  public:
    EulerEquationsBilinearFormBoundary_e(double kappa) : MatrixFormSurf<double>(3,3), kappa(kappa) {}
...
//----------------Bilinearform for K
 ...
 class EulerEquationsBilinearFormDensity : public MatrixFormVol<double>
  {
  public:
    EulerEquationsBilinearFormDensity() : MatrixFormVol<double>(0,0) {}
 ...
 class EulerEquationsBilinearFormDensityVelX : public MatrixFormVol<double>
  {
  public:
    EulerEquationsBilinearFormDensityVelX(double kappa)
      : MatrixFormVol<double>(1,1), kappa(kappa) {}
  ...
  {
  public:
    EulerEquationsBilinearFormDensityVelY(double kappa) 
      : MatrixFormVol<double>(2,2), kappa(kappa) {}
 ...
 class EulerEquationsBilinearFormEnergy : public MatrixFormVol<double>
  {
  public:
    EulerEquationsBilinearFormEnergy(double kappa) 
      : MatrixFormVol<double>(3,3), kappa(kappa) {}
