...
void antidiffusiveFlux(EpetraMatrix<double>* mass_matrix,EpetraMatrix<double>* lumped_matrix,EpetraMatrix<double>* diffusion,EpetraMatrix<double>* matrix_L_low,	double* u_L, double* flux_scalar, double* P_plus, double* P_minus, double* Q_plus, double* Q_minus, double* R_plus, double* R_minus, int dof_rho, int dof_v_x, int dof_v_y, int dof_e )
{ 
...
void lumped_flux_limiter(EpetraMatrix<Scalar>* mass_matrix,EpetraMatrix<Scalar>* lumped_matrix, Scalar* u_L, Scalar* u_H, Scalar* P_plus, Scalar* P_minus, Scalar* Q_plus, Scalar* Q_minus,Scalar* R_plus, Scalar* R_minus, int dof_rho, int dof_v_x, int dof_v_y, int dof_e )
{	
...
//for(int i=0; i<ndof;i++) rhs[i] = u_L[i]*lumped_matrix->get(i,i);
...
double* vals = new double[ndof];
 int* idxs = new int[ndof];
	...
	for(int i=0; i<ndof;i++) u_L[i] = rhs[i]/lumped_matrix->get(i,i);
