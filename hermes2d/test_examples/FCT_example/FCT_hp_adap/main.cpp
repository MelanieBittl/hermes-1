...
AsmList<double>*  dof_list= new AsmList<double>;
	...
	changed = init_adapt(ref_space,&u_prev_time, &u_new,&R_h_1,&R_h_2,&massmatrix, adapting,dof_list,dof_list_2, al, &p1_elements,&neighbor,h_min,h_max);
...
//info("Linear Solver lowOrd");
	...
	//View::wait(HERMES_WAIT_KEYPRESS);
			...
			changed = h_p_adap(ref_space,&u_prev_time, &u_new,&p1_sln,&e_h, &e_h_p,&R_h_1,&R_h_2, &residual, &massmatrix,
