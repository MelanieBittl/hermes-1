...
void Flux_Correction::project_FCT(Solution<double>* sln,double* coeff_vec, double* coeff_vec_2,UMFPackMatrix<double>* mass_matrix,UMFPackMatrix<double>* lumped_matrix, double time_step,OGProjection<double>* ogProjection,	Lumped_Projection* lumpedProjection, Regularity_Estimator* regEst)
{
	if(sln==NULL)
...
//high-order projection		
	ogProjection->project_global(space, sln, coeff_vec_2,SOLVER_UMFPACK, HERMES_L2_NORM);	
