...
int* Regularity_Estimator::get_smooth_elems(Space<double>* new_space, Solution<double>* new_sln,UMFPackMatrix<double> * mass_matrix)
{
	if(new_space == NULL) throw Hermes::Exceptions::Exception("smoothness_indicator: space =NULL");
		if(space!=new_space) set_space(new_space);
		sln = new_sln;
...
int* Regularity_Estimator::get_smooth_dofs(Space<double>* new_space, Solution<double>* new_sln,UMFPackMatrix<double> * mass_matrix)
{
	if(new_space == NULL) throw Hermes::Exceptions::Exception("smoothness_indicator: space =NULL");
		if(space!=new_space) set_space(new_space);
	sln = new_sln;	
