...
//artificial Diffusion with bool fct
UMFPackMatrix<double>* artificialDiffusion(double kappa,double* coeff,H1Space<double>* space_rho,H1Space<double>* space_rho_v_x, H1Space<double>* space_rho_v_y,H1Space<double>* space_e,int dof_rho, int dof_vel_x, int dof_vel_y, int dof_energy,UMFPackMatrix<double>* matrix_K,bool* fct)
{
