...
EpetraMatrix<double>* artificialDiffusion(double kappa,double* coeff,H1Space<double>* space_rho,H1Space<double>* space_rho_v_x, H1Space<double>* space_rho_v_y,H1Space<double>* space_e,int dof_rho, int dof_vel_x, int dof_vel_y, int dof_energy,EpetraMatrix<double>* matrix_K){
  ...
  DiscreteProblem<double> dp_3(&conv_1, Hermes::vector<const Space<double>*>(space_rho, space_rho_v_x, space_rho_v_y, space_e));
...
for(int i = (dof_rho+dof_vel_x+dof_vel_y); i<ndof;i++){
	 ...
	 EpetraMatrix<double>* diffusion = new EpetraMatrix<double>;  
...
//artificial Diffusion mit fct
EpetraMatrix<double>* artificialDiffusion(double kappa,double* coeff,H1Space<double>* space_rho,H1Space<double>* space_rho_v_x, H1Space<double>* space_rho_v_y,H1Space<double>* space_e,int dof_rho, int dof_vel_x, int dof_vel_y, int dof_energy,EpetraMatrix<double>* matrix_K,bool* fct){
