...
public:
	...
	int* get_smooth_elems(Space<double>* new_space,double* coeff_vec,EpetraMatrix<double> * mass_matrix=NULL);
	int* get_smooth_dofs(Space<double>* new_space,double* coeff_vec,EpetraMatrix<double> * mass_matrix=NULL);

	int* get_smooth_elems(Space<double>* new_space,Solution<double>* new_sln,EpetraMatrix<double> * mass_matrix=NULL);
	int* get_smooth_dofs(Space<double>* new_space,Solution<double>* new_sln,EpetraMatrix<double> * mass_matrix=NULL);
...
protected:
	...
	void smoothness_indicator(EpetraMatrix<double> * mass_matrix=NULL);
	...
	Space<double>* space;
	EpetraVector<double> * rhs_1;
	EpetraVector<double> * rhs_2;
