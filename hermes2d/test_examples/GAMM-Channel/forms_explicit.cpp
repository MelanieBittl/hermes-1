...
public:
  ...
  WeakForm<double>(num_of_equations), 
    ...
    updated_prev_density(prev_density), updated_prev_density_vel_x(prev_density_vel_x), updated_prev_density_vel_y(prev_density_vel_y), updated_prev_energy(prev_energy), 
  ...
  WeakForm<double>* clone() const
  {
    ...
    wf = new EulerEquationsWeakFormExplicitDoubleReflection(this->kappa, this->solid_wall_markers, this->prescribed_markers, this->prev_density, this->prev_density_vel_x, this->prev_density_vel_y, this->prev_energy, this->updated_prev_density, this->updated_prev_density_vel_x, this->updated_prev_density_vel_y, this->updated_prev_energy, this->exact_density, this->exact_density_vel_x, this->exact_density_vel_y, this->exact_energy, this->fvm_only, this->neq);
...
public:
    ...
    euler_fluxes(new EulerFluxes(kappa))
  {
    ...
    for(int form_i = 0; form_i < 4; form_i++)
    {
      ...
      add_vector_form_surf(new EulerEquationsVectorFormBdyFlux(form_i, exact_density, exact_density_vel_x, exact_density_vel_y, exact_energy, kappa, prescribed_markers));
      ...
      for(int form_j = 0; form_j < 4; form_j++)
      {
        ...
        add_matrix_form_surf(new EulerEquationsMatrixFormBdyFlux(form_i, form_j, exact_density, exact_density_vel_x, exact_density_vel_y, exact_energy, kappa, prescribed_markers, &this->cacheReadySurf, this->P_plus_cache_surf, this->P_minus_cache_surf));
  ...
  {
  public:
    EulerEquationsMatrixFormBdyFlux(int i, int j, MeshFunctionSharedPtr<double> exact_density, MeshFunctionSharedPtr<double> exact_density_vel_x, MeshFunctionSharedPtr<double> exact_density_vel_y,  MeshFunctionSharedPtr<double> exact_energy, double kappa, std::string marker, bool* cacheReady, double** P_plus_cache, double** P_minus_cache) 
    ...
    EulerEquationsMatrixFormBdyFlux(int i, int j, MeshFunctionSharedPtr<double> exact_density, MeshFunctionSharedPtr<double> exact_density_vel_x, MeshFunctionSharedPtr<double> exact_density_vel_y,  MeshFunctionSharedPtr<double> exact_energy, double kappa, Hermes::vector<std::string> markers, bool* cacheReady, double** P_plus_cache, double** P_minus_cache) 
      : MatrixFormSurf<double>(i, j), exact_density(exact_density), exact_density_vel_x(exact_density_vel_x), exact_density_vel_y(exact_density_vel_y), exact_energy(exact_energy), num_flux(new StegerWarmingNumericalFlux(kappa)), cacheReady(cacheReady), P_plus_cache(P_plus_cache), P_minus_cache(P_minus_cache)
    { 
      set_areas(markers); 
    }
      ...
      Func<double> *v, Geom<double> *e, Func<double>* *ext) const 
    {
      ...
      if(!(*this->cacheReady))
      {
        ...
        for (int point_i = 0; point_i < n; point_i++) 
        {
          ...
          for(int k = 0; k < 4; k++)
            w_B[k] = sln[k]->value(e->x[point_i], e->y[point_i]);
  ...
  {
  public:
    EulerEquationsVectorFormBdyFlux(int i, MeshFunctionSharedPtr<double> exact_density, MeshFunctionSharedPtr<double> exact_density_vel_x, MeshFunctionSharedPtr<double> exact_density_vel_y,  MeshFunctionSharedPtr<double> exact_energy, double kappa, std::string marker) 
    ...
    EulerEquationsVectorFormBdyFlux(int i, MeshFunctionSharedPtr<double> exact_density, MeshFunctionSharedPtr<double> exact_density_vel_x, MeshFunctionSharedPtr<double> exact_density_vel_y,  MeshFunctionSharedPtr<double> exact_energy, double kappa, Hermes::vector<std::string> markers) 
      : VectorFormSurf<double>(i), exact_density(exact_density), exact_density_vel_x(exact_density_vel_x), exact_density_vel_y(exact_density_vel_y), exact_energy(exact_energy), num_flux(new StegerWarmingNumericalFlux(kappa))
    { 
      set_areas(markers); 
    }
